...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (COD, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up preference-tier-mismatch) ==")
    ...
    (println "== filing/submit eng-4 (preference-tier-mismatch -> HARD hold) ==")
