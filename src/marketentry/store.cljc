(ns marketentry.store
  "SSoT for the Democratic Republic of the Congo (COD) market-entry
  ...
  `DatomicStore` uses `langchain-store.core` (`ls/*`) for the EDN-blob
  codec + event-log read/append seam, never a hand-rolled enc/dec*
  (ADR-2607141600 -- the exact two-liner this namespace previously
  carried appears verbatim in ~190 other cloud-itonami actors' own
  store.cljc; this migration removes COD from that count)."
...
(defn demo-data
  ...
  `:congolese-natural-person?` / `:congolese-sme-majority-congolese-
  capital?` / `:congolese-legal-person?` /
  `:grouping-congolese-participation-or-subcontracting?` /
  `:foreign-congolese-economic-activity?` / `:foreign-treaty-
  preference?` / `:claimed-preference-tier` are ground truth for the
  `preference-tier-mismatch` flagship check (Loi n°10/010 Art. 37's 6
  ranked preference tiers); `:requires-nif?` / `:nif-verified?` are
  ground truth for the conditional NIF check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kin Fabrication SARL" :procurement-channel "marche.armp-rdc.cd tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :congolese-natural-person? false :congolese-sme-majority-congolese-capital? true
             :congolese-legal-person? false :grouping-congolese-participation-or-subcontracting? false
             :foreign-congolese-economic-activity? false :foreign-treaty-preference? false
             :claimed-preference-tier 2
             :requires-nif? true :nif-verified? true
             :drafted? false :submitted? false
             :jurisdiction "COD" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :procurement-channel "marche.armp-rdc.cd tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :congolese-natural-person? false :congolese-sme-majority-congolese-capital? true
             :congolese-legal-person? false :grouping-congolese-participation-or-subcontracting? false
    ...
    "eng-3" {:id "eng-3" :operator "Kinshasa Systems SA" :procurement-channel "marche.armp-rdc.cd tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "COD" :status :intake}
    "eng-4" {:id "eng-4" :operator "Lubumbashi Export Ltd" :procurement-channel "marche.armp-rdc.cd tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :congolese-natural-person? false :congolese-sme-majority-congolese-capital? false
             :congolese-legal-person? false :grouping-congolese-participation-or-subcontracting? false
             :foreign-congolese-economic-activity? true :foreign-treaty-preference? false
             :claimed-preference-tier 2
             :requires-nif? true :nif-verified? true
             :drafted? false :submitted? false
             :jurisdiction "COD" :status :intake}
    "eng-5" {:id "eng-5" :operator "Goma Logistics SARL" :procurement-channel "marche.armp-rdc.cd tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :congolese-natural-person? false :congolese-sme-majority-congolese-capital? true
             :congolese-legal-person? false :grouping-congolese-participation-or-subcontracting? false
...
(defn- engagement->tx [{:keys [id operator procurement-channel base-fee monthly-rate monitoring-months claimed-fee
                               congolese-natural-person? congolese-sme-majority-congolese-capital?
                               congolese-legal-person? grouping-congolese-participation-or-subcontracting?
                               foreign-congolese-economic-activity? foreign-treaty-preference?
                               claimed-preference-tier
  ...
  (cond-> {:engagement/id id}
    ...
    (some? congolese-natural-person?)     (assoc :engagement/congolese-natural-person? congolese-natural-person?)
    (some? congolese-sme-majority-congolese-capital?)
    (assoc :engagement/congolese-sme-majority-congolese-capital? congolese-sme-majority-congolese-capital?)
    (some? congolese-legal-person?)       (assoc :engagement/congolese-legal-person? congolese-legal-person?)
    (some? grouping-congolese-participation-or-subcontracting?)
    (assoc :engagement/grouping-congolese-participation-or-subcontracting? grouping-congolese-participation-or-subcontracting?)
    (some? foreign-congolese-economic-activity?)
    (assoc :engagement/foreign-congolese-economic-activity? foreign-congolese-economic-activity?)
    (some? foreign-treaty-preference?)    (assoc :engagement/foreign-treaty-preference? foreign-treaty-preference?)
    claimed-preference-tier               (assoc :engagement/claimed-preference-tier claimed-preference-tier)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/procurement-channel :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/congolese-natural-person? :engagement/congolese-sme-majority-congolese-capital?
   :engagement/congolese-legal-person? :engagement/grouping-congolese-participation-or-subcontracting?
   :engagement/foreign-congolese-economic-activity? :engagement/foreign-treaty-preference?
   :engagement/claimed-preference-tier
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :procurement-channel (:engagement/procurement-channel m)
     ...
     :congolese-natural-person? (boolean (:engagement/congolese-natural-person? m))
     :congolese-sme-majority-congolese-capital? (boolean (:engagement/congolese-sme-majority-congolese-capital? m))
     :congolese-legal-person? (boolean (:engagement/congolese-legal-person? m))
     :grouping-congolese-participation-or-subcontracting? (boolean (:engagement/grouping-congolese-participation-or-subcontracting? m))
     :foreign-congolese-economic-activity? (boolean (:engagement/foreign-congolese-economic-activity? m))
     :foreign-treaty-preference? (boolean (:engagement/foreign-treaty-preference? m))
     :claimed-preference-tier (:engagement/claimed-preference-tier m)
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-cod"})
